...
pub fn from_macos(code: u32) -> Option<u16> {
    let h = match code {
        mac::A => hid::A, mac::B => hid::B, mac::C => hid::C, mac::D => hid::D,
        mac::E => hid::E, mac::F => hid::F, mac::G => hid::G, mac::H => hid::H,
        mac::I => hid::I, mac::J => hid::J, mac::K => hid::K, mac::L => hid::L,
        mac::M => hid::M, mac::N => hid::N, mac::O => hid::O, mac::P => hid::P,
        mac::Q => hid::Q, mac::R => hid::R, mac::S => hid::S, mac::T => hid::T,
        mac::U => hid::U, mac::V => hid::V, mac::W => hid::W, mac::X => hid::X,
        mac::Y => hid::Y, mac::Z => hid::Z,
        mac::N1 => hid::N1, mac::N2 => hid::N2, mac::N3 => hid::N3, mac::N4 => hid::N4,
        mac::N5 => hid::N5, mac::N6 => hid::N6, mac::N7 => hid::N7, mac::N8 => hid::N8,
        mac::N9 => hid::N9, mac::N0 => hid::N0,
        mac::RETURN => hid::RETURN, mac::ESCAPE => hid::ESCAPE,
        mac::BACKSPACE => hid::BACKSPACE, mac::TAB => hid::TAB, mac::SPACE => hid::SPACE,
        mac::MINUS => hid::MINUS, mac::EQUAL => hid::EQUAL,
        mac::LBRACKET => hid::LBRACKET, mac::RBRACKET => hid::RBRACKET,
        mac::BACKSLASH => hid::BACKSLASH, mac::SEMICOLON => hid::SEMICOLON,
        mac::QUOTE => hid::QUOTE, mac::GRAVE => hid::GRAVE,
        mac::COMMA => hid::COMMA, mac::PERIOD => hid::PERIOD, mac::SLASH => hid::SLASH,
        mac::CAPSLOCK => hid::CAPSLOCK,
        mac::F1 => hid::F1, mac::F2 => hid::F2, mac::F3 => hid::F3, mac::F4 => hid::F4,
        mac::F5 => hid::F5, mac::F6 => hid::F6, mac::F7 => hid::F7, mac::F8 => hid::F8,
        mac::F9 => hid::F9, mac::F10 => hid::F10, mac::F11 => hid::F11, mac::F12 => hid::F12,
        mac::RIGHT => hid::RIGHT, mac::LEFT => hid::LEFT, mac::DOWN => hid::DOWN, mac::UP => hid::UP,
        mac::HOME => hid::HOME, mac::PAGE_UP => hid::PAGE_UP,
        mac::DELETE_FORWARD => hid::DELETE_FORWARD,
        mac::END => hid::END, mac::PAGE_DOWN => hid::PAGE_DOWN,
        mac::CTRL => hid::LCTRL, mac::SHIFT => hid::LSHIFT,
        mac::ALT => hid::LALT, mac::META => hid::LMETA,
        _ => return None,
    };
    Some(h)
}
...
pub fn to_macos(hid: u16) -> Option<u32> {
    let m = match hid {
        self::hid::A => mac::A, self::hid::B => mac::B, self::hid::C => mac::C, self::hid::D => mac::D,
        self::hid::E => mac::E, self::hid::F => mac::F, self::hid::G => mac::G, self::hid::H => mac::H,
        self::hid::I => mac::I, self::hid::J => mac::J, self::hid::K => mac::K, self::hid::L => mac::L,
        self::hid::M => mac::M, self::hid::N => mac::N, self::hid::O => mac::O, self::hid::P => mac::P,
        self::hid::Q => mac::Q, self::hid::R => mac::R, self::hid::S => mac::S, self::hid::T => mac::T,
        self::hid::U => mac::U, self::hid::V => mac::V, self::hid::W => mac::W, self::hid::X => mac::X,
        self::hid::Y => mac::Y, self::hid::Z => mac::Z,
        self::hid::N1 => mac::N1, self::hid::N2 => mac::N2, self::hid::N3 => mac::N3, self::hid::N4 => mac::N4,
        self::hid::N5 => mac::N5, self::hid::N6 => mac::N6, self::hid::N7 => mac::N7, self::hid::N8 => mac::N8,
        self::hid::N9 => mac::N9, self::hid::N0 => mac::N0,
        self::hid::RETURN => mac::RETURN, self::hid::ESCAPE => mac::ESCAPE,
        self::hid::BACKSPACE => mac::BACKSPACE, self::hid::TAB => mac::TAB, self::hid::SPACE => mac::SPACE,
        self::hid::MINUS => mac::MINUS, self::hid::EQUAL => mac::EQUAL,
        self::hid::LBRACKET => mac::LBRACKET, self::hid::RBRACKET => mac::RBRACKET,
        self::hid::BACKSLASH => mac::BACKSLASH, self::hid::SEMICOLON => mac::SEMICOLON,
        self::hid::QUOTE => mac::QUOTE, self::hid::GRAVE => mac::GRAVE,
        self::hid::COMMA => mac::COMMA, self::hid::PERIOD => mac::PERIOD, self::hid::SLASH => mac::SLASH,
        self::hid::CAPSLOCK => mac::CAPSLOCK,
        self::hid::F1 => mac::F1, self::hid::F2 => mac::F2, self::hid::F3 => mac::F3, self::hid::F4 => mac::F4,
        self::hid::F5 => mac::F5, self::hid::F6 => mac::F6, self::hid::F7 => mac::F7, self::hid::F8 => mac::F8,
        self::hid::F9 => mac::F9, self::hid::F10 => mac::F10, self::hid::F11 => mac::F11, self::hid::F12 => mac::F12,
        self::hid::RIGHT => mac::RIGHT, self::hid::LEFT => mac::LEFT, self::hid::DOWN => mac::DOWN, self::hid::UP => mac::UP,
        self::hid::HOME => mac::HOME, self::hid::PAGE_UP => mac::PAGE_UP,
        self::hid::DELETE_FORWARD => mac::DELETE_FORWARD,
        self::hid::END => mac::END, self::hid::PAGE_DOWN => mac::PAGE_DOWN,
...
pub fn from_windows(code: u32) -> Option<u16> {
    let h = match code {
        win::A => hid::A, win::B => hid::B, win::C => hid::C, win::D => hid::D,
        win::E => hid::E, win::F => hid::F, win::G => hid::G, win::H => hid::H,
        win::I => hid::I, win::J => hid::J, win::K => hid::K, win::L => hid::L,
        win::M => hid::M, win::N => hid::N, win::O => hid::O, win::P => hid::P,
        win::Q => hid::Q, win::R => hid::R, win::S => hid::S, win::T => hid::T,
        win::U => hid::U, win::V => hid::V, win::W => hid::W, win::X => hid::X,
        win::Y => hid::Y, win::Z => hid::Z,
        win::N1 => hid::N1, win::N2 => hid::N2, win::N3 => hid::N3, win::N4 => hid::N4,
        win::N5 => hid::N5, win::N6 => hid::N6, win::N7 => hid::N7, win::N8 => hid::N8,
        win::N9 => hid::N9, win::N0 => hid::N0,
        win::RETURN => hid::RETURN, win::ESCAPE => hid::ESCAPE,
        win::BACK => hid::BACKSPACE, win::TAB => hid::TAB, win::SPACE => hid::SPACE,
        win::OEM_MINUS => hid::MINUS, win::OEM_PLUS => hid::EQUAL,
        win::OEM_4 => hid::LBRACKET, win::OEM_6 => hid::RBRACKET,
        win::OEM_5 => hid::BACKSLASH, win::OEM_1 => hid::SEMICOLON,
        win::OEM_7 => hid::QUOTE, win::OEM_3 => hid::GRAVE,
        win::OEM_COMMA => hid::COMMA, win::OEM_PERIOD => hid::PERIOD, win::OEM_2 => hid::SLASH,
        win::CAPITAL => hid::CAPSLOCK,
        win::F1 => hid::F1, win::F2 => hid::F2, win::F3 => hid::F3, win::F4 => hid::F4,
        win::F5 => hid::F5, win::F6 => hid::F6, win::F7 => hid::F7, win::F8 => hid::F8,
        win::F9 => hid::F9, win::F10 => hid::F10, win::F11 => hid::F11, win::F12 => hid::F12,
        win::RIGHT => hid::RIGHT, win::LEFT => hid::LEFT,
        win::DOWN => hid::DOWN, win::UP => hid::UP,
        win::HOME => hid::HOME, win::PRIOR => hid::PAGE_UP,
        win::DELETE => hid::DELETE_FORWARD,
        win::END => hid::END, win::NEXT => hid::PAGE_DOWN,
        win::CONTROL | win::LCONTROL => hid::LCTRL, win::RCONTROL => hid::RCTRL,
        win::SHIFT | win::LSHIFT => hid::LSHIFT, win::RSHIFT => hid::RSHIFT,
        win::MENU | win::LMENU => hid::LALT, win::RMENU => hid::RALT,
        win::LWIN => hid::LMETA, win::RWIN => hid::RMETA,
        _ => return None,
    };
    Some(h)
}
...
pub fn to_windows(h: u16) -> Option<u32> {
    let v = match h {
        self::hid::A => win::A, self::hid::B => win::B, self::hid::C => win::C, self::hid::D => win::D,
        self::hid::E => win::E, self::hid::F => win::F, self::hid::G => win::G, self::hid::H => win::H,
        self::hid::I => win::I, self::hid::J => win::J, self::hid::K => win::K, self::hid::L => win::L,
        self::hid::M => win::M, self::hid::N => win::N, self::hid::O => win::O, self::hid::P => win::P,
        self::hid::Q => win::Q, self::hid::R => win::R, self::hid::S => win::S, self::hid::T => win::T,
        self::hid::U => win::U, self::hid::V => win::V, self::hid::W => win::W, self::hid::X => win::X,
        self::hid::Y => win::Y, self::hid::Z => win::Z,
        self::hid::N1 => win::N1, self::hid::N2 => win::N2, self::hid::N3 => win::N3, self::hid::N4 => win::N4,
        self::hid::N5 => win::N5, self::hid::N6 => win::N6, self::hid::N7 => win::N7, self::hid::N8 => win::N8,
        self::hid::N9 => win::N9, self::hid::N0 => win::N0,
        self::hid::RETURN => win::RETURN, self::hid::ESCAPE => win::ESCAPE,
        self::hid::BACKSPACE => win::BACK, self::hid::TAB => win::TAB, self::hid::SPACE => win::SPACE,
        self::hid::MINUS => win::OEM_MINUS, self::hid::EQUAL => win::OEM_PLUS,
        self::hid::LBRACKET => win::OEM_4, self::hid::RBRACKET => win::OEM_6,
        self::hid::BACKSLASH => win::OEM_5, self::hid::SEMICOLON => win::OEM_1,
        self::hid::QUOTE => win::OEM_7, self::hid::GRAVE => win::OEM_3,
        self::hid::COMMA => win::OEM_COMMA, self::hid::PERIOD => win::OEM_PERIOD,
        self::hid::SLASH => win::OEM_2,
        self::hid::CAPSLOCK => win::CAPITAL,
        self::hid::F1 => win::F1, self::hid::F2 => win::F2, self::hid::F3 => win::F3, self::hid::F4 => win::F4,
        self::hid::F5 => win::F5, self::hid::F6 => win::F6, self::hid::F7 => win::F7, self::hid::F8 => win::F8,
        self::hid::F9 => win::F9, self::hid::F10 => win::F10, self::hid::F11 => win::F11, self::hid::F12 => win::F12,
        self::hid::RIGHT => win::RIGHT, self::hid::LEFT => win::LEFT,
        self::hid::DOWN => win::DOWN, self::hid::UP => win::UP,
        self::hid::HOME => win::HOME, self::hid::PAGE_UP => win::PRIOR,
        self::hid::DELETE_FORWARD => win::DELETE,
        self::hid::END => win::END, self::hid::PAGE_DOWN => win::NEXT,
        self::hid::LCTRL => win::LCONTROL, self::hid::RCTRL => win::RCONTROL,
        self::hid::LSHIFT => win::LSHIFT, self::hid::RSHIFT => win::RSHIFT,
        self::hid::LALT => win::LMENU, self::hid::RALT => win::RMENU,
        self::hid::LMETA => win::LWIN, self::hid::RMETA => win::RWIN,
        _ => return None,
    };
    Some(v)
}
...
mod tests {
    ...
    fn win_roundtrip_letters() {
        for code in [win::A, win::Z, win::SPACE, win::ESCAPE, win::F1, win::LEFT, win::OEM_2] {
